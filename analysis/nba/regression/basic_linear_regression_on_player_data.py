...
start_date = dt.date(year=2015, month=4, day=1)
...
combined_df[['missing_draftkings_points', 'missing_seconds_played', 'previous_performance']] = combined_df[['missing_draftkings_points', 'missing_seconds_played', 'previous_performance']].astype(float)
...
cleaned_out_of_sample_df[['missing_draftkings_points', 'missing_seconds_played', 'previous_performance']] = cleaned_out_of_sample_df[['missing_draftkings_points', 'missing_seconds_played', 'previous_performance']].astype(float)
