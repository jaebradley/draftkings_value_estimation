...
end_date = dt.date(year=2015, month=3, day=10)
...
for single_date in daterange(start_date,end_date):
    try:
        ...
        player_data_for_date_df[['missing_draftkings_points', 'missing_seconds_played']] = player_data_for_date_df[['missing_draftkings_points', 'missing_seconds_played']].astype(float)
        cleaned_df = player_data_for_date_df.dropna()
        ...
        independent = X[[
            "avg_opp_conceded_draftkings_score_for_position",
            "weighted_historical_draftkings_score",
            "missing_draftkings_points",
            "missing_seconds_played",
            "last_game",
            "b2b"
        ]]
        teammates = X.drop([
